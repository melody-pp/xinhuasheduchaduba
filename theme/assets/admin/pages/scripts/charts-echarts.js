        ...
        function(ec) {
            ...
            myChart.setOption({
                ...
                series: [{
                    ...
                    name: '评标',
                    type: 'bar',
                    data: [3.0, 6.2, 8.0, 24.2, 29.6, 72.7, 130.6, 160.2, 30.6, 28.0, 7.4, 1.3]
                }, {
                    name: '公示',
                    type: 'bar',
                    data: [1.6, 3.9, 4.0, 20.4, 23.7, 79.7, 155.6, 172.2, 38.7, 13.8, 8.0, 4.3]
                }]
            });
            var myChartLineFourYear = ec.init(document.getElementById('echarts_bar_line_fourYear'));
            myChartLineFourYear.setOption({
                tooltip: {
                    trigger: 'axis'
                },
                legend: {
                    data: ['预算总金额', '合同总金额', '结余总金额']
                },
                toolbox: {
                    show: false,
                    feature: {
                ...
                series: [{
                    ...
                    name: '结余总金额',
                    type: 'line',
                    data: [29.6, 72.7, 130.6, 160.2]
                }]
            });
             var myChartLineEightYear = ec.init(document.getElementById('echarts_bar_line_eightYear'));
            myChartLineEightYear.setOption({
                tooltip: {
                    trigger: 'axis'
                },
                legend: {
                ...
                series: [{
                    name: '预算总金额',
                    type: 'line',
                    data: [2.0, 4.9, 7.0, 23.2,11.5,21.9,33.8,5.6]
                }, {
                    name: '合同总金额',
                    type: 'line',
                    data: [182.2, 48.7, 18.8, 6.0,100,94,38.9,120]
                }, {
                    name: '结余总金额',
                    type: 'line',
                    data: [29.6, 72.7, 130.6, 160.2,170,180,190,200]
                }]
            });
             var myChartLineTenYear = ec.init(document.getElementById('echarts_bar_line_tenYear'));
            myChartLineTenYear.setOption({
                tooltip: {
                    trigger: 'axis'
                },
                legend: {
                ...
                series:[{
                    name: '预算总金额',
                    type: 'line',
                    data: [2.0, 4.9, 7.0, 23.2,11.5,21.9,33.8,5.6,88,4.2]
                }, {
                    name: '合同总金额',
                    type: 'line',
                    data: [182.2, 48.7, 18.8, 6.0,100,94,38.9,120,122,143]
                }, {
                    name: '结余总金额',
                    type: 'line',
                    data: [29.6, 72.7, 130.6, 160.2,170,180,190,200,75,81]
                }]
            });
